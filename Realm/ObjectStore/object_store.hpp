...
namespace realm {
    ...
    public:
        ...
        static void verify_and_update_column_mapping(Group *group, ObjectSchema &target_schema);
    ...
    public:
        ...
        ObjectStoreException kind() { return m_kind; }
    ...
    public:
        ObjectStoreValidationException(std::vector<std::string> validation_errors) : m_validation_errors(validation_errors) {}
